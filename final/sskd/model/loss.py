...
class DiverseExpertLoss(nn.Module):
    ...
    def forward(self, output_logits, target, extra_info=None, epoch=None, num_epochs=None):
        if extra_info is None:
        ...
        loss += (1.0+alpha)*self.base_loss(expert1_logits, target)
        ...
        loss += (1.0-alpha)*self.base_loss(expert3_logits, target)
