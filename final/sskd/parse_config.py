...
class ConfigParser:
    def __init__(self, config, resume=None, modification=None, load_crt=None, run_id=None):
        ...
        self._log_dir = save_dir / 'models' / exper_name
    ...
    def init_obj(self, name, module, *args, allow_override=False, data_dir=None, **kwargs):
        """
        ...
        module_args = dict(self[name]['args']
                           ) if 'args' in self[name] else dict()
        if data_dir is not None:
            module_args['data_dir'] = data_dir
