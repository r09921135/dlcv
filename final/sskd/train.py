    ...
    if "type" in config._config["lr_scheduler"]:
        if config["lr_scheduler"]["type"] == "CustomLR":  # linear learning rate decay
            ...
            lr_scheduler = config.init_obj(
                'lr_scheduler', torch.optim.lr_scheduler, optimizer)  # cosine learning rate decay
    else:
        lr_scheduler = None
    return lr_scheduler
...
def main(config, data_dir):
    ...
    data_loader = config.init_obj(
        'data_loader', module_data, data_dir=data_dir)
